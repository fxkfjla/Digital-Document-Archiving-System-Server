...
public class AuthController
{
    ...
    @PostMapping("/login")
    public ResponseEntity<ApiResponse<String>> login(@Valid @RequestBody LoginRequest user)
    {
    ...
    // Requestheader
    @PostMapping("/logout")
    public ResponseEntity<ApiResponse<String>> logout(@Valid @RequestBody TokenRequest token)
    {
